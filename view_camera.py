...
class AgentCameraViewer:
    def __init__(self, world, vehicle, width, height, fov):
        ...
        # Renderizar en CARLA a la mitad de resolución para ganar rendimiento
    ...
    def _parse_image(weak_self, image):
        ...
        array = array[:, :, ::-1]    # BGR -> RGB (Pygame usa RGB)
...
def main():
    ...
    try:
        while running:
            # Mantener un framerate máximo constante en la interfaz
            clock.tick(30)

            # Esperar a los ticks del entrenamiento de CARLA
            world.wait_for_tick()

            # Comprobar eventos de Pygame
            ...
            # Buscar o reenganchar al vehículo si ha muerto
